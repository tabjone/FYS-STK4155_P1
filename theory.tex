...
%closely resembles lecture notes, and WILL REWRITE the beginning here ASAP to make coherent and understandable.
Since $\boldsymbol{\hat{\beta}}=\boldsymbol{\hat\beta}(\boldsymbol{X})$ is a function of random variables, $\boldsymbol{\hat\beta}$ itself must be a random variable. Thus it has
...
%LECTURE NOTES, NOT LOOKED AT THIS YET ALMOST
...
%%ALL AFTER THIS IS JUNK THAT MAY BE INCLUDED
