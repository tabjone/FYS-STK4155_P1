...
\subsubsection{Ridge NOT DONE}
???? Ride regression is a solution to the imprecision of least square estimators when linear regression models have highly correlated independent variables.  ?????



We can re-write the optimisation problem
$$
{\displaystyle \min_{\boldsymbol{\beta}\in
